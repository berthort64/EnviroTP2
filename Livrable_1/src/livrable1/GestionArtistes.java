...
public class GestionArtistes extends JFrame {
	...
	public GestionArtistes() {
		setResizable(false);
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(FenetreTraitement.class.getResource("/livrable1/MusicNote.png")));
		...
		list.addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent arg0) {
				label.setIcon(new ImageIcon(
						new ImageIcon(this.getClass().getResource(list.getSelectedValue().toString() + ".png"))
		...
		btnRechercher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				table.setModel(new DefaultTableModel(liste, new String[] { "No", "Nom", "Membre" }) {
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_1.getText().equals("")) {
					JOptionPane.showMessageDialog(null, "Veuillez s�lectionner un artiste.", "Erreur",
							JOptionPane.ERROR_MESSAGE);
				} else {
					if (validerChamps()) {
						con.Modifier(textField_1.getText(), textField_2.getText(),
								chckbxMember.isSelected() ? "true" : "false", currentpath);
						btnRechercher.doClick();
					} else {
						JOptionPane.showMessageDialog(null, "Veuillez vous assurer que tous les champs sont valides.");
					}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (textField_1.getText().equals("")) {
					...
					JOptionPane.showMessageDialog(null,
							"Aucun enregistrement s�lectionn�, veuillez s�lectionner un enregistrement");
					...
					if (JOptionPane.showConfirmDialog(null,
							"Voulez vous r�ellement effacer l'enrigstrement n� " + id + " ?", "Confirmation",
		...
		btnRemplacer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (chooser.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					ImageIcon image;
					try {
						image = new ImageIcon(new ImageIcon(ImageIO.read(new File(newPhoto))).getImage()
		...
		ImageIcon image = new ImageIcon(new ImageIcon(this.getClass().getResource("MusicNote.png")).getImage()
				.getScaledInstance(90, 90, Image.SCALE_DEFAULT));
		...
		table.setModel(new DefaultTableModel(new Object[0][3], new String[] { "No", "Nom", "Membre" }
		...
		mntmAideEnLigne.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					File fleFichier = new File("help.chm");
					Desktop.getDesktop().open(fleFichier);
				} catch (IOException msg) {
					
					System.out.println("Erreur lors de l'obtention de l'aide en ligne");
				}
		...
		table.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
			public void valueChanged(ListSelectionEvent event) {
				if (table.getSelectedRow() != -1) {
					...
					try {
						// test image
						ImageIcon image = new ImageIcon(new ImageIcon(ImageIO.read(new File(artiste.getPhoto())))
								.getImage().getScaledInstance(90, 90, Image.SCALE_DEFAULT));
					...
					chckbxMember.setSelected(
							table.getValueAt(table.getSelectedRow(), 2).toString().equalsIgnoreCase("oui"));
