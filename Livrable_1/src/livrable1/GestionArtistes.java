...
public class GestionArtistes extends JFrame {
	...
	public GestionArtistes() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (textField_1.getText().equals("") ? true : JOptionPane.showConfirmDialog(null, "Attention!\n\nVous n'aviez pas cr̩̩ un nouvel enregistrement avant de remplir les champs.\nVoulez-vous tout de m̻me enregistrer un nouvel artiste (avec un nouvel identifiant) avec les donn̩es fournies?") == JOptionPane.YES_OPTION) {
					if (validerChamps()) {
